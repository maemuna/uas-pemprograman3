...
<?php
 $query =mysqli_query($koneksi, "SELECT * FROM barang INNER JOIN kategori ON barang.kategori_id = kategori.id_kategori INNER JOIN satuan ON barang.satuan_id = satuan.id_satuan");
 $no=1;
